...
$('.ddw2').val(0);
setTimeout(function(){
	$('.num').eq(0).find('p').eq(0).fadeIn('slow').stop().animate({'bottom':'40%','left':'45%','opacity': '1'},1500)
},500);
setTimeout(function(){
	$('.num').eq(0).find('p').eq(1).fadeIn('slow').stop().animate({'bottom':'40%','right':'45%','opacity': '1'},1500)
},2500);
$(function(){
